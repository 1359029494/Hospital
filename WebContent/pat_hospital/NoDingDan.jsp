...
<script type="text/javascript" src="pospital/js/jquery-3.2.1.js"></script>
<script type="text/javascript">
			...
			function tiaozhuan(){
				window.open("pat_hospital/dindanzhifu.jsp","_parent");
			}
	</script>
</head>
	<!-- 
					...
					<tr>
						...
						<td>
							<span class="aspan" style="margin-left: 0px">
								<a href="dodingdanzhifu?orprice=${dingdan1.orprice }&orid=${dingdan1.ornumber }" onclick="tiaozhuan()" target="_blank" style="color: #ffffff">去缴费</a>
							</span>
						</td>
						</c:otherwise>
						</c:choose>
						<td style="width: 120px;">
							<span class="aspan" style="margin-left: 0px">
								<a href="deletedingdan?ornumber=${dingdan1.ornumber }" target="_parent" style="color: #ffffff">删除订单</a>
							</span>
						</td>
					</tr>
				</c:forEach>
