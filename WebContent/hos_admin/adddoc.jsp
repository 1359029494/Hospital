...
<meta charset="UTF-8">
	...
	<link rel="stylesheet" type="text/css" href="admin/css/emailAutoComple.css"/>
						...
						<ul>
							...
							<li class="ydc-menu-item">
								...
								<ul>
									...
									<li>
										<a href="adddoc.jsp" class="active">新增医生</a>
									</li>
									<li>
					...
					<div class="ydc-release-content">
						<div class="ydc-tabPanel ydc-tabPanel-release">
							...
							<div class="ydc-panes">
									...
									<form action="/hospital/Adddoc" method="post" enctype="multipart/form-data" onsubmit="return dosub()">
						<div class="ydc-reg-form-class ydc-reg-form-reg" style="margin-top: 30px;">
							<div class="ydc-reg-form-group clearfix">
								<label>联系手机:</label>
								<div class="ydc-reg-form-input">
									<input type="text" id="user4" name="docphonenumber" class="ydc-form-control" autocomplete="off" placeholder="">
									<label id="c4"></label>
							...
							<div class="ydc-reg-form-group clearfix">
								<label>帐号头像:</label>
								<div class="ydc-reg-form-input">
									<input type="file" id="file" name="docphoto" class="" autocomplete="off" placeholder="">
									<div class="ydc-reg-form-text">
							...
							<div class="ydc-reg-form-group clearfix">
								<label>姓名:</label>
								<div class="ydc-reg-form-input">
									<input type="text" id="name" name="docname" class="ydc-form-control" autocomplete="off" placeholder="">
								</div>
							</div>
							<div class="ydc-reg-form-group clearfix">
								<label>身份证号:</label>
								<div class="ydc-reg-form-input clearfix">
									<input type="text" id="user2" name="docidcard" class="ydc-form-control" autocomplete="off" placeholder="">
									...
									<div class="ydc-warning-default fl" style="height:auto; font-size:12px;">
										<p>帐号信息填写需真实有效，如发现虚假以及非个人真<br/>实信息导致帐号收益无法提取，责任由帐号个人承担</p>
									</div>
								</div>
							...
							<div class="ydc-reg-form-group clearfix">
								<label>年龄:</label>
								<div class="ydc-reg-form-input">
									<input type="text" readonly="readonly" id="user1" name="docage" class="ydc-form-control" autocomplete="off" placeholder="">
							...
							<div class="ydc-reg-form-group clearfix">
								<label>性别:</label>
								<div class="ydc-reg-form-input">
									<input type="radio" id="woman"  name="docsex" value="0" checked="checked"/>女
							...
							<div class="ydc-reg-form-group clearfix">
								<label>所在城市:</label>
								<div class="ydc-reg-form-input">
									<select name="docaddress1" id="ddlProvince" onchange="selectMoreCity(this)">
										<option>请输入所在省</option>
									</select>
									<select name="docaddress2" id="ddlCity">
							...
							<div class="ydc-reg-form-group clearfix">
								<label>邮箱:</label>
								<div class="ydc-reg-form-input">
									<input name="docmail" id="patmail" class="patmail ydc-form-control" type="text"/>
									<label id="c3"></label>
								</div>
								<div class="ydc-reg-form-text">
							...
							<div class="ydc-reg-form-group clearfix">
								<label>密码:</label>
								<div class="ydc-reg-form-input">
									<input type="password" id="user5" name="docpass" class="ydc-form-control" autocomplete="off" placeholder="">
									<label id="c6"></label>
								</div>
								<div class="ydc-reg-form-text">
									<p>请务必牢记密码</p>
					...
					<c:if test="${!empty doctor}">
						...
						<div class="ydc-reg-form-class ydc-reg-form-reg" style="margin-top: 30px;">
							<div class="ydc-reg-form-group clearfix">
								<label>联系手机:</label>
								<div class="ydc-reg-form-input">
									<input type="text" value="${doctor.docphonenumber }" id="user4" name="docphonenumber" class="ydc-form-control" autocomplete="off" placeholder="">
									<label id="c4"></label>
									<div class="ydc-reg-form-text">
										<p>请输入手机号并作为你的账号</p>
									</div>
							...
							<div class="ydc-reg-form-group clearfix">
								<label>姓名:</label>
								<div class="ydc-reg-form-input">
									<input type="text" value="${doctor.docname }" id="name" name="docname" class="ydc-form-control" autocomplete="off" placeholder="">
								</div>
							</div>
							<div class="ydc-reg-form-group clearfix">
								<label>身份证号:</label>
								<div class="ydc-reg-form-input clearfix">
									<input type="text" value="${doctor.docidcard }" id="user2" name="docidcard" class="ydc-form-control" autocomplete="off" placeholder="">
									<label id="c2" style="text-align: left; color:red; text-align:left; font-size:12px"></label>
									<div class="ydc-warning-default fl" style="height:auto; font-size:12px;">
										<p>帐号信息填写需真实有效，如发现虚假以及非个人真<br/>实信息导致帐号收益无法提取，责任由帐号个人承担</p>
									</div>
							...
							<div class="ydc-reg-form-group clearfix">
								<label>年龄:</label>
								<div class="ydc-reg-form-input">
									<input type="text" readonly="readonly" value="${doctor.docage }" id="user1" name="docage" class="ydc-form-control" autocomplete="off" placeholder="">
									<label id="c1" style="text-align: left; color:red; text-align:left; font-size:12px"></label>
								</div>
							</div>
							<div class="ydc-reg-form-group clearfix">
								<label>性别:</label>
								<div class="ydc-reg-form-input">
								<c:if test="${doctor.docsex==0 }">
									<input type="radio" id="woman"  name="docsex" value="0" checked="checked"/>女
									<input type="radio" id="man" name="docsex" value="1"  />男
								</c:if>
								<c:if test="${doctor.docsex==1 }">
									<input type="radio"  name="docsex" value="0" />女
									<input type="radio" name="docsex" value="1" checked="checked" />男
								</c:if>
								</div>
							</div>
							<div class="ydc-reg-form-group clearfix">
								...
								<div class="ydc-reg-form-input">
									<select name="docdept" id="sub">
									<c:if test="${doctor.docdept == null }">
										<option value="1">请选择科室</option>
									</c:if>
									<c:if test="${doctor.docdept != null }">
										<option value="${doctor.docdept }" selected>${doctor.docdept }</option>
									</c:if>
									</select>
								</div>
							...
							<div class="ydc-reg-form-group clearfix">
								<label>邮箱:</label>
								<div class="ydc-reg-form-input">
									<input name="docmail" value="${doctor.docmail }" id="patmail" class="patmail ydc-form-control" type="text"/>
									<label id="c3"></label>
								</div>
								<div class="ydc-reg-form-text">
									<p>请使用自己日常使用邮箱便于接受相关信息</p>
...
<!-- content YDC end -->
   ...
   $('#user1').blur(function(){
	   var age = document.getElementById("user1").value;
	   var reg = new RegExp("^[0-9]*$");
   	var c1 = document.getElementById("c1");
   	if(!reg.test(age)){
           c1.innerHTML = "请输入数字年龄";
       }
       if(reg.test(age)){
       	c1.innerHTML = "";;
       }
   ...
   $('#user5').blur(function(){
       ...
       if(reg.test(pass)){
    	   c6.innerHTML = "√";
    	   c6.style="color:green;text-align: left; text-align:left; font-size:12px"
       }
   })
   $('#patmail').blur(function(){
   	...
   	if(!reg.test(mail)){
           c3.innerHTML = "×邮箱错误";
           c3.style="text-align: left; color:red; text-align:left; font-size:12px"
       }
       if(reg.test(mail)){
       	c3.innerHTML = "√邮箱正确";
       	c3.style="color:green;text-align: left; text-align:left; font-size:12px"
       }
   })
    ...
    $('#user4').blur(function(){
       ...
       if(reg.test(phone)){
       		   $.post("/hospital/Docphone2",{phone:phone},function(data){
       			  	if(data){
   ...
   function dosub(){
	   ...
	   var phone = document.getElementById("user4").value;
	   var reg4 = /^1[3|4|5|7|8][0-9]\d{4,8}$/;
