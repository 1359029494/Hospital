...
public class Filter1 implements Filter {
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain chain)
		...
		if (url.equals("admlogin.html")
				...
				|| url1.equals("jpg")
				|| url.equals("Login") 
				|| url.equals("admligin.jsp") 
				|| url.equals("dozhuxiao") 
				...
				|| url.equals("Appduanxinyanzheng")
				|| url.equals("AppRegister")
				|| url.equals("pat_dologin")
				|| url.equals("docheckphoneforupdatepass")
		...
		Patient p2 = (Patient)session.getAttribute("pat");
		if (user == null && p==null && d==null && p2 == null) {// 管理员没有登录
			response.sendRedirect("/hospital/pat_hospital/parlogin.jsp");
		} else {// 成功
			chain.doFilter(request, response);
		}
	}
