...
<html>
	<head>
		...
		<script src="pat_hospital/js/jquery-1.8.3.min.js" type="text/javascript"></script>
    ...
    <div class="search style="float:right;" >
    	<form action="domedicine" method="post"> 
	        <table border="" cellspacing="" cellpadding=""  >
	        	...
	        	<tr><td>   <input type="text" placeholder="请输入药品"  id="drugname" style="display: inline;border-radius: 3px;" name="drugname"></td>
		...
		<div class="">
			...
			<c:if test="${list!=null }">
	        	...
	        	<c:forEach items="${list }" var="x">
	        		<li>
		                <dl>
	                    	<dd><a href="dolookdrug?drugid=${x.drid} " target="_blank"><img src="<%=request.getContextPath() %>/hos_admin/admin/${x.drphoto}" alt="药品" height="100px"/></a></dd>
	                        <dt>
      			...
      			<td style="text-align: center;">
		      		<c:if test="${pagenow==1 }">
						...
						<c:if test="${pagenow!=totalpage }">
					    	...
					    	<input type="text" value="${pagenow }" size="4" id="pageValue" class="footer_input" style="box-shadow: black 0 0 5px; width: 60px;"></input>
							<a onclick="gotopage()" class="footer_input" style="background-color:#00AEF0 ; cursor:pointer ; color: #ffffff;box-shadow: black 0 0 5px;padding: 5px 10px;">跳转</a>
					</td>
				</tr>
			</table>
      	</div>
...
<script src="pat_hospital/js/waypoints.min.js"></script> 
