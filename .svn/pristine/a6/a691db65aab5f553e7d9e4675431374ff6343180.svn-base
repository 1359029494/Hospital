...
/**
 * Servlet implementation class DoBackDrugLastAction
 */
public class DoBackDrugLastAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoBackDrugLastAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//用于完成自动补全的信息填充
		//从搜索框接收值
		String term=request.getParameter("drugname");
