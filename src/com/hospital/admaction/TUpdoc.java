	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i = 0; i < list.size(); i++) {
			...
			if(flag >= 0) {
				...
				out.println("<script>");
				out.println("alert('修改成功！');window.location.href='/hospital/hos_admin/Managedoc'");
				out.println("</script>");
				out.println("</head>");
				out.println("</html>");
				...
				out.println("<script>");
				out.println("alert('修改失败！');window.location.href='hos_admin/updoc.jsp' onClick=”javascript :history.back(-1);”");
				out.println("</script>");
			}
		}
	}
